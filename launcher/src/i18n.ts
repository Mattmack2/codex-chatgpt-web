...
const en = {
  ...
  browserSolTitle: "Browser Sol",
  browserSolProject: "Project evodevo",
  browserSolOpen: "Open/Resume Browser Sol",
  browserSolArm: "Arm",
  browserSolDisarm: "Disarm",
  browserSolTest: "Test Wake",
  browserSolBrowserStatus: "Browser/ChatGPT",
  browserSolBrowserReady: "READY",
  browserSolBrowserError: "ERROR",
  browserSolTaskStatus: "ChatGPT task",
  browserSolConnected: "CONNECTED",
  browserSolBusy: "BUSY",
  browserSolUnavailable: "UNAVAILABLE",
  browserSolWake: "Auto Wake",
  browserSolArmed: "ARMED",
  browserSolOff: "OFF",
  browserSolProviders: "Providers active / queued",
  browserSolWave: "Wave",
  browserSolSettlement: "Settlement",
  browserSolLastWake: "Last wake",
  browserSolContext: "Context",
  browserSolNormal: "NORMAL",
  browserSolCheckpointing: "CHECKPOINTING",
  browserSolRolledOver: "ROLLED OVER",
  browserSolLastRollover: "Last rollover",
  browserSolNoValue: "—",
  browserSolPending: "Pending wake",
  browserSolPendingBody: "will be delivered when the durable task is attachable",
...
const zh: Record<keyof typeof en, string> = {
  ...
  browserSolTitle: "Browser Sol",
  browserSolProject: "项目 evodevo",
  browserSolOpen: "打开/恢复 Browser Sol",
  browserSolArm: "启用",
  browserSolDisarm: "停用",
  browserSolTest: "测试唤醒",
  browserSolBrowserStatus: "浏览器/ChatGPT",
  browserSolBrowserReady: "就绪",
  browserSolBrowserError: "错误",
  browserSolTaskStatus: "ChatGPT 任务",
  browserSolConnected: "已连接",
  browserSolBusy: "忙碌",
  browserSolUnavailable: "不可用",
  browserSolWake: "自动唤醒",
  browserSolArmed: "已启用",
  browserSolOff: "关闭",
  browserSolProviders: "Provider 活跃 / 排队",
  browserSolWave: "波次",
  browserSolSettlement: "结算",
  browserSolLastWake: "上次唤醒",
  browserSolContext: "上下文",
  browserSolNormal: "正常",
  browserSolCheckpointing: "正在压缩",
  browserSolRolledOver: "已滚动切换",
  browserSolLastRollover: "上次滚动切换",
  browserSolNoValue: "—",
  browserSolPending: "待处理唤醒",
  browserSolPendingBody: "持久任务可连接后将发送",
  browserReady: "浏览器已就绪",
...
const ja: Record<keyof typeof en, string> = {
  ...
  browserSolTitle: "Browser Sol",
  browserSolProject: "プロジェクト evodevo",
  browserSolOpen: "Browser Sol を開く/再開",
  browserSolArm: "有効化",
  browserSolDisarm: "無効化",
  browserSolTest: "ウェイクをテスト",
  browserSolBrowserStatus: "ブラウザー/ChatGPT",
  browserSolBrowserReady: "準備完了",
  browserSolBrowserError: "エラー",
  browserSolTaskStatus: "ChatGPT タスク",
  browserSolConnected: "接続済み",
  browserSolBusy: "実行中",
  browserSolUnavailable: "利用不可",
  browserSolWake: "自動ウェイク",
  browserSolArmed: "有効",
  browserSolOff: "オフ",
  browserSolProviders: "Provider アクティブ / キュー",
  browserSolWave: "ウェーブ",
  browserSolSettlement: "セトルメント",
  browserSolLastWake: "前回のウェイク",
  browserSolContext: "コンテキスト",
  browserSolNormal: "通常",
  browserSolCheckpointing: "チェックポイント中",
  browserSolRolledOver: "ロールオーバー済み",
  browserSolLastRollover: "前回のロールオーバー",
  browserSolNoValue: "—",
  browserSolPending: "保留中のウェイク",
  browserSolPendingBody: "永続タスクに接続できると配信されます",
