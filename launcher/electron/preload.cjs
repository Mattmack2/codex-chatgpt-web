...
contextBridge.exposeInMainWorld("codexWebLauncher", {
  ...
  browserSolSelect: (projectKey) => ipcRenderer.invoke("launcher:browser-sol-select", projectKey),
  browserSolCreate: (input) => ipcRenderer.invoke("launcher:browser-sol-create", input),
  browserSolOpen: (projectKey) => ipcRenderer.invoke("launcher:browser-sol-open", projectKey),
  browserSolSetAutomation: (projectKey, enabled) => ipcRenderer.invoke(
    "launcher:browser-sol-automation",
    projectKey,
    enabled,
  ),
  browserSolTestWake: (projectKey) => ipcRenderer.invoke("launcher:browser-sol-test-wake", projectKey),
  ...
  onBrowserSolState: (listener) => subscription("launcher:browser-sol-state", listener),
