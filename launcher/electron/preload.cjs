...
contextBridge.exposeInMainWorld("codexWebLauncher", {
  ...
  openBrowserSol: () => ipcRenderer.invoke("launcher:browser-sol-open"),
  armBrowserSol: () => ipcRenderer.invoke("launcher:browser-sol-arm"),
  disarmBrowserSol: () => ipcRenderer.invoke("launcher:browser-sol-disarm"),
  testBrowserSolWake: () => ipcRenderer.invoke("launcher:browser-sol-test-wake"),
